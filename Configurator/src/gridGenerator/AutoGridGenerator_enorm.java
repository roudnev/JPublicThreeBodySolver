 ...
 * @author roudnev
 */
public class AutoGridGenerator_enorm
{
  public static void main(String[] argv) throws Exception
  {
   ...
   double m2=m1;
    ...
    AutoGridGenerator_enorm generator=new AutoGridGenerator_enorm("lm2m2Potential",rMass,cutOff,massNorm,outputFrame);
  }
// Fields:
...
//  }
  //
  public AutoGridGenerator_enorm(String potentialName,double reducedMass, double cutOff, double massNorm, MyTextOutputJFrame outputFrame) throws Exception
  {
    double massFactor=2*reducedMass/massNorm;
    double scaling=Math.sqrt(massFactor);
    potential=new WeightedPotential(potentialName, scaling, massNorm);
